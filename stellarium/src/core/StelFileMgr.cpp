...
void StelFileMgr::init()
{
	...
	{
        userDir = winApiPath + "\\Stellarium-n9";
	}
#elif defined(Q_OS_MAC)
    userDir = QDir::homePath() + "/Library/Application Support/Stellarium-n9";
#else
    userDir = QDir::homePath() + "/.stellarium-n9";
#endif
...
QString StelFileMgr::getLocaleDir()
{
	...
	{
        //qDebug() << "Locale path: " << localePath.filePath();
