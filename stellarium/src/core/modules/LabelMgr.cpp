...
bool SkyLabel::draw(StelCore* core, StelPainter& sPainter)
{
    ...
    sPainter.drawText(labelXY[0]+xOffset-jxOffset, labelXY[1]+yOffset-jyOffset, labelText, angle, 0, 0, false);
...
bool ScreenLabel::draw(StelCore*, StelPainter& sPainter)
{
    ...
    float angle = StelApp::getInstance().getCore()->getOrientationAngle();
    sPainter.drawText(screenX, screenY, labelText, angle, 0, 0, false);
	return true;
}
