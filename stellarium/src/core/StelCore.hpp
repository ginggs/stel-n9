...
public:
    ...
    bool getPortraitMode() const { return portraitMode; }
    void setPortraitMode(bool p);

    float getOrientationAngle() const { return portraitMode ? 90.f : 0.f; }
...
private:
    ...
    Mat4d matFreeToJ2000;
    Mat4d matJ2000ToFree;
    ...
    //QtMobility::QRotationSensor* rotSensor;
    StelSensors* sensors;
